...
You will also need **VS Code**
[find VSCode here](https://code.visualstudio.com/)

**Usage Example:**
To run, open *Martin_Caleb_Week4* in VSCode and click the play button in the top right.
[There is also a guide on how to run python files in the command line here but be warned it might be out of date](https://www.wikihow.com/Use-Windows-Command-Prompt-to-Run-a-Python-File)

**License and Author Information:**
This Repository was created by Caleb Martin and is not protected by a license of any kind. Feel free to take and use to your heart's content.